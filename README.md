...
| 书源 | 文件 | 说明 |
|---|---|---|
| 起点中文网·全能版 | [起点中文网·全能版.json](起点中文网·全能版.json) | 搜索/发现/目录/正文全功能；`[女]+书名` 搜女频 |
| 知轩藏书 | [知轩藏书书源.json](知轩藏书书源.json) | 书讯发现源（TXT下载站，无在线正文） |
| 书源精简版 | [书源精简版.json](书源精简版.json) | 起点系 7 个功能不重复的可用源 |
